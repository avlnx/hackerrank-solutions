...
func finalPositionsFor(fruits []int32, treePos int32) []int32 {
	newFruitPos := make([]int32, 0)
	for _, pos := range fruits {
		newFruitPos = append(newFruitPos, pos+treePos)
	}
	return newFruitPos
}

func numOfFruitsBetweenRange(fruits []int32, s int32, t int32) int32 {
	var counter int32 = 0
...
func countApplesAndOranges(s int32, t int32, a int32, b int32, apples []int32, oranges []int32) {
	apples = finalPositionsFor(apples, a)
	oranges = finalPositionsFor(oranges, b)
	applesInRange := numOfFruitsBetweenRange(apples, s, t)
	orangesInRange := numOfFruitsBetweenRange(oranges, s, t)
